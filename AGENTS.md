...
| Fixture | **Generate** stable data matching stated counts (fixed IDs) in `fixtures/seed-data.json` | Single seed file at repo root; IDs never regenerated on seed/startup. |
